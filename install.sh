...
# fluxcd-policyctl installation script
# Usage: curl -sSL https://raw.githubusercontent.com/nikogura/fluxcd-policyctl/main/install.sh | sh

REPO="nikogura/fluxcd-policyctl"
...
install_binary() {
    ...
    print_status "  ${BINARY_NAME} --bind-address=:9999   # Use different port"
    echo
...
main() {
    echo
    print_status "Installing fluxcd-policyctl - Flux CD Image Policy Control"
    echo
